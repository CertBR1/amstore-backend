...
export class AppModule implements NestModule {
  configure(consumer: MiddlewareConsumer) {
    ...
    consumer
      ...
      .exclude({ path: '/servico/:id', method: RequestMethod.GET, })
      .exclude({ path: '/categoria/:id', method: RequestMethod.GET, })
      .exclude({ path: '/subcategoria/:id', method: RequestMethod.GET, })
    ...
    consumer
      ...
      .forRoutes(
        { path: '/cliente/:id', method: RequestMethod.GET }
      );
      consumer
        .apply(ClienteAuthMiddleware)
        .forRoutes(
          { path: '/cliente/pedido/:id', method: RequestMethod.GET }
        );
  }
}
